...
* Студент: [Александр Снятков](https://up.htmlacademy.ru/htmlcss/24/user/879641).
* Наставник: `
Удовенко Марина)))`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/879641-technomart-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
